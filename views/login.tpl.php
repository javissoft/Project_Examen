        ...
        <div class="col-sm-4">
            ...
            <div class="panel-body">
                <form action='mylogin.net' method='POST' name ='frmdo' id='frmdo' target = '_self'>
                    ...
                    <tr><td><span class="label-primary">*Usuario:</span></td></td><td><input type='text' name='user'  placeholder='Usuario' ></td></tr>
                    <tr><td><span class="label-primary">*Password:</span></td><td><input type='password' name='password'  placeholder='Contraseña'></td></tr>
